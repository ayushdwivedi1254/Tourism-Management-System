				...
				<tbody>
						<%try{
							...
							while(rs.next()){
								...
								<td><%=packagecost %></td>
								<%
								Connection con1 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism", "akd", "helloakd");
								...
								Connection con3 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism", "akd", "helloakd");
								...
								Connection con4 = DriverManager.getConnection("jdbc:mysql://localhost:3306/tourism", "akd", "helloakd");
								...
								totalcost = packagecost+roomcost+transportcost;
								%>
								<td><%=totalcost %></td>
